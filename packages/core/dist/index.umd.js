...
`;function Wt(t){const e=t.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"\0").replace(/\*/g,"[^/]*").replace(/ /g,".*").replace(/\?/g,".");return new RegExp(`^${e}$`)}function T(t,e){if(!t)return!0;if(t.regex)try{return new RegExp(t.regex).test(e)}catch{return!1}if(t.glob)try{return Wt(t.glob).test(e)}catch{return!1}return!0}function mt(t){if(!t||!t.glob)return null;const e=t.glob.replace(/\*+/g,"");return/^https?:\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:null}function q(t=window.innerWidth){return t<=640?"mobile":t<=1024?"tablet":"desktop"}function gt(t,e){if(t.url&&!T(t.url,e.url))return!1;if(t.tags&&t.tags.length>0){const r=e.tags??[];for(const n of t.tags)if(!r.includes(n))return!1}return!(t.firstVisitOnly&&!e.firstVisit||t.device&&t.device!==e.device||t.unlessSeen&&e.seenCount>0||t.maxShows!==void 0&&e.seenCount>=t.maxShows)}function bt(t,e){return!t||gt(t,e)}function wt(t,e){return!t||t.length===0?!0:t.some(r=>gt(r.when,e))}const G="tours:locationchange";let yt=!1;function Vt(){if(!yt){yt=!0;for(const t of["pushState","replaceState"]){const e=history[t];history[t]=function(...n){const s=e.apply(this,n);return window.dispatchEvent(new Event(G)),s}}}}function K(t){return Vt(),window.addEventListener("popstate",t),window.addEventListener("hashchange",t),window.addEventListener(G,t),()=>{window.removeEventListener("popstate",t),window.removeEventListener("hashchange",t),window.removeEventListener(G,t)}}const U="tours:progress";function Xt(){return{get(t){try{return localStorage.getItem(t)}catch{return null}},set(t,e){try{localStorage.setItem(t,e)}catch{}},remove(t){try{localStorage.removeItem(t)}catch{}}}}function J(t){const e=t.get(U);if(!e)return null;try{const r=JSON.parse(e);if(typeof r?.tourId=="string"&&typeof r?.index=="number")return r}catch{}return null}function N(t,e){t.set(U,JSON.stringify(e))}function O(t){t.remove(U)}const vt="tours:seen:";function F(t,e){const r=t.get(vt+e),n=r?parseInt(r,10):0;return Number.isNaN(n)?0:n}function xt(t,e){t.set(vt+e,String(F(t,e)+1))}const jt=`
:host { all: initial; }
