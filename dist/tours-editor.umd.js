...
`;let T=null;function B(){if(T!==null)return T;try{T=new URLSearchParams(window.location.search).has("use_logs")}catch{T=!1}return T}function M(r){const e=`[tours:${r}]`;return{log:(...t)=>{B()&&console.log(e,...t)},warn:(...t)=>{B()&&console.warn(e,...t)},error:(...t)=>{B()&&console.error(e,...t)}}}function ue(r){if(r.id)return`#${CSS.escape(r.id)}`;const e=[];let t=r;for(;t&&t!==document.body&&t.nodeType===1;){const n=t.tagName.toLowerCase(),o=t.parentElement;if(!o){e.unshift(n);break}const i=Array.from(o.children).filter(a=>a.tagName===t.tagName);if(i.length>1){const a=i.indexOf(t)+1;e.unshift(`${n}:nth-of-type(${a})`)}else e.unshift(n);t=o}return`body > ${e.join(" > ")}`}function he(r,e={}){const t=M("picker");let n=null,o=null,i=null,a=!1;function d(u){if(u===n)return!0;for(const f of e.ignore??[])if(f&&f.contains(u))return!0;return!1}function l(){if(n)return;n=document.createElement("div"),n.setAttribute("data-tours-picker",""),o=n.attachShadow({mode:"open"});const u=document.createElement("style");u.textContent=L,o.appendChild(u),i=document.createElement("div"),i.className="tours-picker-overlay",i.style.display="none",o.appendChild(i);const f=document.createElement("div");f.className="tours-picker-hint",f.textContent="Hover and click an element • Esc to cancel",o.appendChild(f),document.body.appendChild(n)}function p(u,f){const h=document.elementFromPoint(u,f);return!h||d(h)?null:h}function g(u){if(!a||!i)return;const f=p(u.clientX,u.clientY);if(!f){i.style.display="none";return}const h=f.getBoundingClientRect();i.style.display="block",i.style.left=`${h.left}px`,i.style.top=`${h.top}px`,i.style.width=`${h.width}px`,i.style.height=`${h.height}px`}function x(u){if(!a)return;const f=p(u.clientX,u.clientY);if(u.preventDefault(),u.stopPropagation(),!f)return;const h=ue(f);t.log("picked",h),_(),r([h])}function k(u){u.key==="Escape"&&(u.preventDefault(),_())}function E(){a||(a=!0,t.log("start"),l(),document.addEventListener("mousemove",g,!0),document.addEventListener("click",x,!0),document.addEventListener("keydown",k,!0))}function _(){a&&(a=!1,document.removeEventListener("mousemove",g,!0),document.removeEventListener("click",x,!0),document.removeEventListener("keydown",k,!0),n&&n.parentNode&&n.parentNode.removeChild(n),n=null,o=null,i=null)}return{start:E,stop:_}}const j=6,U=6,V=10,F=12,fe=1;function w(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function G(r){return w(r)&&typeof r.default=="string"}const K=["top","bottom","left","right","auto"],Z=["start","center","end"],Q=["mobile","tablet","desktop"],ee=["click","input","navigate","none"];function te(r,e,t){if(!w(r)){t.push(`${e} must be an object`);return}const n=typeof r.glob=="string"&&r.glob.length>0,o=typeof r.regex=="string"&&r.regex.length>0;if(!n&&!o&&t.push(`${e} must have a non-empty "glob" or "regex"`),o)try{new RegExp(r.regex)}catch{t.push(`${e}.regex is not a valid regular expression`)}}function ne(r,e,t){if(!w(r)){t.push(`${e} must be an object`);return}r.url!==void 0&&te(r.url,`${e}.url`,t),r.role!==void 0&&typeof r.role!="string"&&t.push(`${e}.role must be a string`),r.firstVisitOnly!==void 0&&typeof r.firstVisitOnly!="boolean"&&t.push(`${e}.firstVisitOnly must be a boolean`),r.device!==void 0&&!Q.includes(r.device)&&t.push(`${e}.device must be one of ${Q.join("|")}`),r.unlessSeen!==void 0&&typeof r.unlessSeen!="boolean"&&t.push(`${e}.unlessSeen must be a boolean`),r.maxShows!==void 0&&(typeof r.maxShows!="number"||r.maxShows<0)&&t.push(`${e}.maxShows must be a non-negative number`)}function ge(r,e,t){if(!w(r)){t.push(`${e} must be an object`);return}ee.includes(r.type)||t.push(`${e}.type must be one of ${ee.join("|")}`),r.url!==void 0&&typeof r.url!="string"&&t.push(`${e}.url must be a string`),r.value!==void 0&&typeof r.value!="string"&&t.push(`${e}.value must be a string`)}function be(r){const e=[];if(!w(r))return{ok:!1,errors:["tour must be an object"]};if((typeof r.id!="string"||r.id.length===0)&&e.push("tour.id must be a non-empty string"),typeof r.schemaVersion!="number"&&e.push("tour.schemaVersion must be a number"),G(r.title)||e.push('tour.title must be a localized text with a string "default"'),Array.isArray(r.steps)?r.steps.length===0?e.push("tour.steps must contain at least one step"):r.steps.forEach((t,n)=>{if(!w(t)){e.push(`steps[${n}] must be an object`);return}(typeof t.id!="string"||t.id.length===0)&&e.push(`steps[${n}].id must be a non-empty string`),(!Array.isArray(t.selectors)||t.selectors.length===0||!t.selectors.every(o=>typeof o=="string"&&o.length>0))&&e.push(`steps[${n}].selectors must be a non-empty array of non-empty strings`),G(t.content)||e.push(`steps[${n}].content must be a localized text with a string "default"`),t.placement!==void 0&&!K.includes(t.placement)&&e.push(`steps[${n}].placement must be one of ${K.join("|")}`),t.align!==void 0&&!Z.includes(t.align)&&e.push(`steps[${n}].align must be one of ${Z.join("|")}`),t.pageUrl!==void 0&&te(t.pageUrl,`steps[${n}].pageUrl`,e),t.condition!==void 0&&ne(t.condition,`steps[${n}].condition`,e),t.action!==void 0&&ge(t.action,`steps[${n}].action`,e)}):e.push("tour.steps must be an array"),r.display!==void 0)if(!w(r.display))e.push("tour.display must be an object");else for(const t of["padding","radius","cardRadius","offset","alignOffset"]){const n=r.display[t];n!==void 0&&(typeof n!="number"||n<0)&&e.push(`tour.display.${t} must be a non-negative number`)}return r.rules!==void 0&&(Array.isArray(r.rules)?r.rules.forEach((t,n)=>{if(!w(t)){e.push(`rules[${n}] must be an object`);return}t.tourId!==void 0&&typeof t.tourId!="string"&&e.push(`rules[${n}].tourId must be a string`),t.when===void 0?e.push(`rules[${n}].when is required`):ne(t.when,`rules[${n}].when`,e)}):e.push("tour.rules must be an array")),e.length>0?{ok:!1,errors:e}:{ok:!0,tour:r}}function ve(r,e,t){const n={top:r.top,bottom:t.height-r.bottom,left:r.left,right:t.width-r.right},o={top:e.height,bottom:e.height,left:e.width,right:e.width},i=["bottom","top","right","left"],a=i.find(d=>n[d]>=o[d]+8);return a||i.reduce((d,l)=>n[l]>n[d]?l:d,i[0])}function re(r){const{target:e,card:t,offset:n,viewport:o}=r,i=r.side==="auto",a=i?ve(e,t,o):r.side,d=i?"center":r.align,l=r.alignOffset??0,p=d==="start"?l:d==="end"?-l:0;let g=0,x=0;return a==="top"||a==="bottom"?(g=a==="top"?e.top-t.height-n:e.bottom+n,x=d==="start"?e.left:d==="end"?e.right-t.width:e.left+e.width/2-t.width/2,x+=p):(x=a==="left"?e.left-t.width-n:e.right+n,g=d==="start"?e.top:d==="end"?e.bottom-t.height:e.top+e.height/2-t.height/2,g+=p),x=Math.max(8,Math.min(x,o.width-t.width-8)),g=Math.max(8,Math.min(g,o.height-t.height-8)),{top:g,left:x}}function xe(r){var ae,de,le,ce;const e=M("player");let t=null,n=null,o=null,i=null,a=!1,d=0;const l=((ae=r.display)==null?void 0:ae.padding)??j,p=((de=r.display)==null?void 0:de.radius)??U,g=((le=r.display)==null?void 0:le.cardRadius)??V,x=((ce=r.display)==null?void 0:ce.offset)??F;function k(c){for(const b of c.selectors)try{const v=document.querySelector(b);if(v)return v}catch{}return null}function E(){if(t)return;t=document.createElement("div"),t.setAttribute("data-tours-player",""),n=t.attachShadow({mode:"open"});const c=document.createElement("style");c.textContent=pe,n.appendChild(c);const b=document.createElement("div");b.className="tours-backdrop",n.appendChild(b),o=document.createElement("div"),o.className="tours-spotlight",o.style.borderRadius=`${p}px`,n.appendChild(o),i=document.createElement("div"),i.className="tours-tooltip",i.style.borderRadius=`${g}px`,n.appendChild(i),document.body.appendChild(t)}function _(c){o&&(o.style.display="block",o.style.left=`${c.left-l}px`,o.style.top=`${c.top-l}px`,o.style.width=`${c.width+l*2}px`,o.style.height=`${c.height+l*2}px`)}function u(c,b){var S;if(!i)return;const{top:v,left:I}=re({target:c,card:{width:i.offsetWidth,height:i.offsetHeight},side:b.placement??"bottom",align:b.align??"center",offset:x,alignOffset:((S=r.display)==null?void 0:S.alignOffset)??0,viewport:{width:window.innerWidth,height:window.innerHeight}});i.style.left=`${I}px`,i.style.top=`${v}px`}function f(c){if(!i)return;const b=r.steps.length;i.textContent="";const v=document.createElement("button");v.className="tours-close",v.type="button",v.textContent="×",v.setAttribute("aria-label","Close"),v.addEventListener("click",C),i.appendChild(v);const I=document.createElement("p");I.className="tours-tooltip__content",I.textContent=c.content.default,i.appendChild(I);const S=document.createElement("div");S.className="tours-tooltip__footer";const X=document.createElement("span");X.className="tours-tooltip__progress",X.textContent=`Step ${d+1} of ${b}`,S.appendChild(X);const D=document.createElement("div");D.className="tours-tooltip__buttons";const $=document.createElement("button");$.className="tours-btn",$.type="button",$.textContent="Back",$.disabled=d===0,$.addEventListener("click",q),D.appendChild($);const N=document.createElement("button");N.className="tours-btn tours-btn--primary",N.type="button",N.textContent=d===b-1?"Done":"Next",N.addEventListener("click",Y),D.appendChild(N),S.appendChild(D),i.appendChild(S)}function h(){if(!a)return;const c=r.steps[d];if(!c){C();return}e.log("render step",d,c.id);const b=k(c);if(!b){e.warn(`step "${c.id}" skipped: no element for selectors`,c.selectors),d<r.steps.length-1?(d+=1,h()):C();return}E(),b.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),f(c);const v=b.getBoundingClientRect();_(v),u(v,c)}function P(c){a&&(c.key==="Escape"?(c.preventDefault(),C()):c.key==="ArrowRight"?Y():c.key==="ArrowLeft"&&q())}function R(){if(!a)return;const c=r.steps[d];if(!c)return;const b=k(c);if(!b)return;const v=b.getBoundingClientRect();_(v),u(v,c)}function _e(){a||r.steps.length!==0&&(a=!0,d=0,e.log("start",r.id,`${r.steps.length} steps`),E(),window.addEventListener("keydown",P,!0),window.addEventListener("resize",R,!0),window.addEventListener("scroll",R,!0),h())}function C(){a&&(a=!1,e.log("stop"),window.removeEventListener("keydown",P,!0),window.removeEventListener("resize",R,!0),window.removeEventListener("scroll",R,!0),t&&t.parentNode&&t.parentNode.removeChild(t),t=null,n=null,o=null,i=null)}function Y(){if(a){if(d>=r.steps.length-1){C();return}d+=1,h()}}function q(){a&&(d<=0||(d-=1,h()))}return{start:_e,stop:C,next:Y,prev:q}}const me=`
:host {
  all: initial;
  --e-bg: #ffffff;
  --e-fg: #1f2733;
