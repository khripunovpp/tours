...
/**
 * SPA demo on Solid — @solidjs/router (HashRouter, Route, A), the idiomatic
 * setup. The tour crosses routes with no reload.
 */
...
import { playerState, wireDemoPanel, makeSpaTour } from './common.js';
