(function(w,I){typeof exports=="object"&&typeof module<"u"?I(exports):typeof define=="function"&&define.amd?define(["exports"],I):(w=typeof globalThis<"u"?globalThis:w||self,I(w.Tours={}))})(this,(function(w){"use strict";const I=`
:host {
  all: initial;
}
...
`;let N=null;function B(){if(N!==null)return N;try{N=new URLSearchParams(window.location.search).has("use_logs")}catch{N=!1}return N}function O(r){const e=`[tours:${r}]`;return{log:(...t)=>{B()&&console.log(e,...t)},warn:(...t)=>{B()&&console.warn(e,...t)},error:(...t)=>{B()&&console.error(e,...t)}}}function de(r){if(r.id)return`#${CSS.escape(r.id)}`;const e=[];let t=r;for(;t&&t!==document.body&&t.nodeType===1;){const n=t.tagName.toLowerCase(),o=t.parentElement;if(!o){e.unshift(n);break}const i=Array.from(o.children).filter(s=>s.tagName===t.tagName);if(i.length>1){const s=i.indexOf(t)+1;e.unshift(`${n}:nth-of-type(${s})`)}else e.unshift(n);t=o}return`body > ${e.join(" > ")}`}function le(r,e={}){const t=O("picker");let n=null,o=null,i=null,s=!1;function d(p){if(p===n)return!0;for(const c of e.ignore??[])if(c&&c.contains(p))return!0;return!1}function u(){if(n)return;n=document.createElement("div"),n.setAttribute("data-tours-picker",""),o=n.attachShadow({mode:"open"});const p=document.createElement("style");p.textContent=I,o.appendChild(p),i=document.createElement("div"),i.className="tours-picker-overlay",i.style.display="none",o.appendChild(i);const c=document.createElement("div");c.className="tours-picker-hint",c.textContent="Hover and click an element • Esc to cancel",o.appendChild(c),document.body.appendChild(n)}function f(p,c){const b=document.elementFromPoint(p,c);return!b||d(b)?null:b}function g(p){if(!s||!i)return;const c=f(p.clientX,p.clientY);if(!c){i.style.display="none";return}const b=c.getBoundingClientRect();i.style.display="block",i.style.left=`${b.left}px`,i.style.top=`${b.top}px`,i.style.width=`${b.width}px`,i.style.height=`${b.height}px`}function v(p){if(!s)return;const c=f(p.clientX,p.clientY);if(p.preventDefault(),p.stopPropagation(),!c)return;const b=de(c);t.log("picked",b),E(),r([b])}function C(p){p.key==="Escape"&&(p.preventDefault(),E())}function L(){s||(s=!0,t.log("start"),u(),document.addEventListener("mousemove",g,!0),document.addEventListener("click",v,!0),document.addEventListener("keydown",C,!0))}function E(){s&&(s=!1,document.removeEventListener("mousemove",g,!0),document.removeEventListener("click",v,!0),document.removeEventListener("keydown",C,!0),n&&n.parentNode&&n.parentNode.removeChild(n),n=null,o=null,i=null)}return{start:L,stop:E}}const j=6,U=6,V=10,ce=1;function S(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function q(r){return S(r)&&typeof r.default=="string"}const X=["top","bottom","left","right"],G=["mobile","tablet","desktop"],K=["click","input","navigate","none"];function Z(r,e,t){if(!S(r)){t.push(`${e} must be an object`);return}const n=typeof r.glob=="string"&&r.glob.length>0,o=typeof r.regex=="string"&&r.regex.length>0;if(!n&&!o&&t.push(`${e} must have a non-empty "glob" or "regex"`),o)try{new RegExp(r.regex)}catch{t.push(`${e}.regex is not a valid regular expression`)}}function Q(r,e,t){if(!S(r)){t.push(`${e} must be an object`);return}r.url!==void 0&&Z(r.url,`${e}.url`,t),r.role!==void 0&&typeof r.role!="string"&&t.push(`${e}.role must be a string`),r.firstVisitOnly!==void 0&&typeof r.firstVisitOnly!="boolean"&&t.push(`${e}.firstVisitOnly must be a boolean`),r.device!==void 0&&!G.includes(r.device)&&t.push(`${e}.device must be one of ${G.join("|")}`),r.unlessSeen!==void 0&&typeof r.unlessSeen!="boolean"&&t.push(`${e}.unlessSeen must be a boolean`),r.maxShows!==void 0&&(typeof r.maxShows!="number"||r.maxShows<0)&&t.push(`${e}.maxShows must be a non-negative number`)}function pe(r,e,t){if(!S(r)){t.push(`${e} must be an object`);return}K.includes(r.type)||t.push(`${e}.type must be one of ${K.join("|")}`),r.url!==void 0&&typeof r.url!="string"&&t.push(`${e}.url must be a string`),r.value!==void 0&&typeof r.value!="string"&&t.push(`${e}.value must be a string`)}function ue(r){const e=[];if(!S(r))return{ok:!1,errors:["tour must be an object"]};if((typeof r.id!="string"||r.id.length===0)&&e.push("tour.id must be a non-empty string"),typeof r.schemaVersion!="number"&&e.push("tour.schemaVersion must be a number"),q(r.title)||e.push('tour.title must be a localized text with a string "default"'),Array.isArray(r.steps)?r.steps.length===0?e.push("tour.steps must contain at least one step"):r.steps.forEach((t,n)=>{if(!S(t)){e.push(`steps[${n}] must be an object`);return}(typeof t.id!="string"||t.id.length===0)&&e.push(`steps[${n}].id must be a non-empty string`),(!Array.isArray(t.selectors)||t.selectors.length===0||!t.selectors.every(o=>typeof o=="string"&&o.length>0))&&e.push(`steps[${n}].selectors must be a non-empty array of non-empty strings`),q(t.content)||e.push(`steps[${n}].content must be a localized text with a string "default"`),t.placement!==void 0&&!X.includes(t.placement)&&e.push(`steps[${n}].placement must be one of ${X.join("|")}`),t.pageUrl!==void 0&&Z(t.pageUrl,`steps[${n}].pageUrl`,e),t.condition!==void 0&&Q(t.condition,`steps[${n}].condition`,e),t.action!==void 0&&pe(t.action,`steps[${n}].action`,e)}):e.push("tour.steps must be an array"),r.display!==void 0)if(!S(r.display))e.push("tour.display must be an object");else for(const t of["padding","radius","cardRadius"]){const n=r.display[t];n!==void 0&&(typeof n!="number"||n<0)&&e.push(`tour.display.${t} must be a non-negative number`)}return r.rules!==void 0&&(Array.isArray(r.rules)?r.rules.forEach((t,n)=>{if(!S(t)){e.push(`rules[${n}] must be an object`);return}t.tourId!==void 0&&typeof t.tourId!="string"&&e.push(`rules[${n}].tourId must be a string`),t.when===void 0?e.push(`rules[${n}].when is required`):Q(t.when,`rules[${n}].when`,e)}):e.push("tour.rules must be an array")),e.length>0?{ok:!1,errors:e}:{ok:!0,tour:r}}const z=12;function he(r){var oe,ie,se;const e=O("player");let t=null,n=null,o=null,i=null,s=!1,d=0;const u=((oe=r.display)==null?void 0:oe.padding)??j,f=((ie=r.display)==null?void 0:ie.radius)??U,g=((se=r.display)==null?void 0:se.cardRadius)??V;function v(l){for(const m of l.selectors)try{const h=document.querySelector(m);if(h)return h}catch{}return null}function C(){if(t)return;t=document.createElement("div"),t.setAttribute("data-tours-player",""),n=t.attachShadow({mode:"open"});const l=document.createElement("style");l.textContent=ae,n.appendChild(l);const m=document.createElement("div");m.className="tours-backdrop",n.appendChild(m),o=document.createElement("div"),o.className="tours-spotlight",o.style.borderRadius=`${f}px`,n.appendChild(o),i=document.createElement("div"),i.className="tours-tooltip",i.style.borderRadius=`${g}px`,n.appendChild(i),document.body.appendChild(t)}function L(l){o&&(o.style.display="block",o.style.left=`${l.left-u}px`,o.style.top=`${l.top-u}px`,o.style.width=`${l.width+u*2}px`,o.style.height=`${l.height+u*2}px`)}function E(l,m){if(!i)return;const h=i.offsetWidth,_=i.offsetHeight,A=window.innerWidth,P=window.innerHeight;let x,y;const $=m??"bottom";switch($){case"top":x=l.top-_-z,y=l.left+l.width/2-h/2;break;case"left":x=l.top+l.height/2-_/2,y=l.left-h-z;break;case"right":x=l.top+l.height/2-_/2,y=l.right+z;break;case"bottom":default:x=l.bottom+z,y=l.left+l.width/2-h/2;break}$==="bottom"&&x+_>P&&(x=l.top-_-z),y=Math.max(8,Math.min(y,A-h-8)),x=Math.max(8,Math.min(x,P-_-8)),i.style.left=`${y}px`,i.style.top=`${x}px`}function p(l){if(!i)return;const m=r.steps.length;i.textContent="";const h=document.createElement("button");h.className="tours-close",h.type="button",h.textContent="×",h.setAttribute("aria-label","Close"),h.addEventListener("click",T),i.appendChild(h);const _=document.createElement("p");_.className="tours-tooltip__content",_.textContent=l.content.default,i.appendChild(_);const A=document.createElement("div");A.className="tours-tooltip__footer";const P=document.createElement("span");P.className="tours-tooltip__progress",P.textContent=`Step ${d+1} of ${m}`,A.appendChild(P);const x=document.createElement("div");x.className="tours-tooltip__buttons";const y=document.createElement("button");y.className="tours-btn",y.type="button",y.textContent="Back",y.disabled=d===0,y.addEventListener("click",Y),x.appendChild(y);const $=document.createElement("button");$.className="tours-btn tours-btn--primary",$.type="button",$.textContent=d===m-1?"Done":"Next",$.addEventListener("click",J),x.appendChild($),A.appendChild(x),i.appendChild(A)}function c(){if(!s)return;const l=r.steps[d];if(!l){T();return}e.log("render step",d,l.id);const m=v(l);if(!m){e.warn(`step "${l.id}" skipped: no element for selectors`,l.selectors),d<r.steps.length-1?(d+=1,c()):T();return}C(),m.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),p(l);const h=m.getBoundingClientRect();L(h),E(h,l.placement)}function b(l){s&&(l.key==="Escape"?(l.preventDefault(),T()):l.key==="ArrowRight"?J():l.key==="ArrowLeft"&&Y())}function M(){if(!s)return;const l=r.steps[d];if(!l)return;const m=v(l);if(!m)return;const h=m.getBoundingClientRect();L(h),E(h,l.placement)}function ve(){s||r.steps.length!==0&&(s=!0,d=0,e.log("start",r.id,`${r.steps.length} steps`),C(),window.addEventListener("keydown",b,!0),window.addEventListener("resize",M,!0),window.addEventListener("scroll",M,!0),c())}function T(){s&&(s=!1,e.log("stop"),window.removeEventListener("keydown",b,!0),window.removeEventListener("resize",M,!0),window.removeEventListener("scroll",M,!0),t&&t.parentNode&&t.parentNode.removeChild(t),t=null,n=null,o=null,i=null)}function J(){if(s){if(d>=r.steps.length-1){T();return}d+=1,c()}}function Y(){s&&(d<=0||(d-=1,c()))}return{start:ve,stop:T,next:J,prev:Y}}const fe=`
:host {
  all: initial;
  --e-bg: #ffffff;
  --e-fg: #1f2733;
