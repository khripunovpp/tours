(function(y,A){typeof exports=="object"&&typeof module<"u"?A(exports):typeof define=="function"&&define.amd?define(["exports"],A):(y=typeof globalThis<"u"?globalThis:y||self,A(y.SiteToursAdmin={}))})(this,(function(y){"use strict";const A=`
:host {
  all: initial;
}
...
`;function J(r){return JSON.stringify(r)}function Le(r){return/^[a-zA-Z][\w-]*$/.test(r)&&r.length<=30&&!/\d{2,}/.test(r)&&!/^(css-|sc-|jsx-|emotion-|_|is-|has-)/.test(r)}function ne(r){const e=[];let t=r;for(;t&&t!==document.body&&t.nodeType===1;){const n=t.tagName.toLowerCase(),i=t.parentElement;if(!i){e.unshift(n);break}const o=Array.from(i.children).filter(s=>s.tagName===t.tagName);e.unshift(o.length>1?`${n}:nth-of-type(${o.indexOf(t)+1})`:n),t=i}return`body > ${e.join(" > ")}`}function Te(r){let e=r.parentElement;for(;e&&e!==document.body&&!e.id;)e=e.parentElement;if(!e||!e.id)return null;const t=[];let n=r;for(;n&&n!==e;){const i=n.tagName.toLowerCase(),o=n.parentElement;if(!o)return null;const s=Array.from(o.children).filter(l=>l.tagName===n.tagName);t.unshift(s.length>1?`${i}:nth-of-type(${s.indexOf(n)+1})`:i),n=o}return`#${CSS.escape(e.id)} > ${t.join(" > ")}`}const Pe=["data-testid","data-test","data-test-id","data-cy","data-qa","data-id","data-name"];function Ae(r){const e=[],t=new Set,n=r.tagName.toLowerCase(),i=d=>{if(!(!d||t.has(d)))try{document.querySelector(d)===r&&(t.add(d),e.push(d))}catch{}};r.id&&i(`#${CSS.escape(r.id)}`);for(const d of Pe){const u=r.getAttribute(d);u&&i(`${n}[${d}=${J(u)}]`)}const o=r.getAttribute("name");o&&i(`${n}[name=${J(o)}]`);const s=r.getAttribute("aria-label");s&&i(`[aria-label=${J(s)}]`);const l=Array.from(r.classList).filter(Le);l.length&&i(`${n}.${l.map(d=>CSS.escape(d)).join(".")}`);for(const d of l)i(`${n}.${CSS.escape(d)}`);i(Te(r)),i(ne(r));const c=(r.textContent??"").replace(/\s+/g," ").trim();if(c&&c.length<=50&&/^(a|button|summary|label|h[1-6])$/.test(n)){const d=`text=${c}`;t.has(d)||(t.add(d),e.push(d))}return e.length===0&&e.push(ne(r)),e}const Ne="a, button, summary, label, h1, h2, h3, h4, h5, h6";function re(r,e){return!(r instanceof Element)||!r.isConnected||e!==document&&e instanceof Node&&!e.contains(r)?null:r}function Oe(r,e){if(typeof r=="function"){let t;try{t=r()}catch{return null}return re(t,e)}if(typeof r!="string")return re(r,e);if(r.startsWith("text=")){const t=r.slice(5).trim();for(const n of Array.from(e.querySelectorAll(Ne)))if((n.textContent??"").replace(/\s+/g," ").trim()===t)return n;return null}try{return e.querySelector(r)}catch{return null}}function M(r,e=document){for(const t of r){const n=Oe(t,e);if(n)return n}return null}function Re(r,e={}){const t=e.root??document,n=M(r,t);return n?Promise.resolve(n):new Promise(i=>{let o=!1,s;const l=u=>{o||(o=!0,c.disconnect(),s&&clearTimeout(s),i(u))},c=new MutationObserver(()=>{const u=M(r,t);u&&l(u)});c.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0});const d=e.timeout??4e3;d>0&&Number.isFinite(d)&&(s=setTimeout(()=>l(null),d))})}let N=null;function Y(){if(N!==null)return N;try{N=new URLSearchParams(window.location.search).has("use_logs")}catch{N=!1}return N}function q(r){const e=`[tours:${r}]`;return{log:(...t)=>{Y()&&console.log(e,...t)},warn:(...t)=>{Y()&&console.warn(e,...t)},error:(...t)=>{Y()&&console.error(e,...t)}}}function Ie(r,e={}){const t=q("picker");let n=null,i=null,o=null,s=!1;function l(h){if(h===n)return!0;for(const m of e.ignore??[])if(m&&m.contains(h))return!0;return!1}function c(){if(n)return;n=document.createElement("div"),n.setAttribute("data-tours-picker",""),i=n.attachShadow({mode:"open"});const h=document.createElement("style");h.textContent=A,i.appendChild(h),o=document.createElement("div"),o.className="tours-picker-overlay",o.style.display="none",i.appendChild(o);const m=document.createElement("div");m.className="tours-picker-hint",m.textContent="Hover and click an element • Esc to cancel",i.appendChild(m),document.body.appendChild(n)}function d(h,m){const x=document.elementFromPoint(h,m);return!x||l(x)?null:x}function u(h){if(!s||!o)return;const m=d(h.clientX,h.clientY);if(!m){o.style.display="none";return}const x=m.getBoundingClientRect();o.style.display="block",o.style.left=`${x.left}px`,o.style.top=`${x.top}px`,o.style.width=`${x.width}px`,o.style.height=`${x.height}px`}function f(h){if(!s)return;const m=d(h.clientX,h.clientY);if(h.preventDefault(),h.stopPropagation(),!m)return;const x=Ae(m);t.log("picked",x),S(),r(x)}function b(h){h.key==="Escape"&&(h.preventDefault(),S())}function R(){s||(s=!0,t.log("start"),c(),document.addEventListener("mousemove",u,!0),document.addEventListener("click",f,!0),document.addEventListener("keydown",b,!0))}function S(){s&&(s=!1,document.removeEventListener("mousemove",u,!0),document.removeEventListener("click",f,!0),document.removeEventListener("keydown",b,!0),n&&n.parentNode&&n.parentNode.removeChild(n),n=null,i=null,o=null)}return{start:R,stop:S}}const z=6,D=6,B=10,F=12,Me=1;function C(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function ie(r){return C(r)&&typeof r.default=="string"}const oe=["top","bottom","left","right","auto"],se=["start","center","end"],ae=["mobile","tablet","desktop"],de=["click","input","navigate","none"];function le(r,e,t){if(!C(r)){t.push(`${e} must be an object`);return}const n=typeof r.glob=="string"&&r.glob.length>0,i=typeof r.regex=="string"&&r.regex.length>0;if(!n&&!i&&t.push(`${e} must have a non-empty "glob" or "regex"`),i)try{new RegExp(r.regex)}catch{t.push(`${e}.regex is not a valid regular expression`)}}function ce(r,e,t){if(!C(r)){t.push(`${e} must be an object`);return}r.url!==void 0&&le(r.url,`${e}.url`,t),r.role!==void 0&&typeof r.role!="string"&&t.push(`${e}.role must be a string`),r.firstVisitOnly!==void 0&&typeof r.firstVisitOnly!="boolean"&&t.push(`${e}.firstVisitOnly must be a boolean`),r.device!==void 0&&!ae.includes(r.device)&&t.push(`${e}.device must be one of ${ae.join("|")}`),r.unlessSeen!==void 0&&typeof r.unlessSeen!="boolean"&&t.push(`${e}.unlessSeen must be a boolean`),r.maxShows!==void 0&&(typeof r.maxShows!="number"||r.maxShows<0)&&t.push(`${e}.maxShows must be a non-negative number`)}function ze(r,e,t){if(!C(r)){t.push(`${e} must be an object`);return}de.includes(r.type)||t.push(`${e}.type must be one of ${de.join("|")}`),r.url!==void 0&&typeof r.url!="string"&&t.push(`${e}.url must be a string`),r.value!==void 0&&typeof r.value!="string"&&t.push(`${e}.value must be a string`)}function De(r){const e=[];if(!C(r))return{ok:!1,errors:["tour must be an object"]};if((typeof r.id!="string"||r.id.length===0)&&e.push("tour.id must be a non-empty string"),typeof r.schemaVersion!="number"&&e.push("tour.schemaVersion must be a number"),ie(r.title)||e.push('tour.title must be a localized text with a string "default"'),Array.isArray(r.steps)?r.steps.length===0?e.push("tour.steps must contain at least one step"):r.steps.forEach((t,n)=>{if(!C(t)){e.push(`steps[${n}] must be an object`);return}(typeof t.id!="string"||t.id.length===0)&&e.push(`steps[${n}].id must be a non-empty string`),(!Array.isArray(t.selectors)||t.selectors.length===0||!t.selectors.every(i=>typeof i=="string"&&i.length>0))&&e.push(`steps[${n}].selectors must be a non-empty array of non-empty strings`),ie(t.content)||e.push(`steps[${n}].content must be a localized text with a string "default"`),t.placement!==void 0&&!oe.includes(t.placement)&&e.push(`steps[${n}].placement must be one of ${oe.join("|")}`),t.align!==void 0&&!se.includes(t.align)&&e.push(`steps[${n}].align must be one of ${se.join("|")}`),t.backLabel!==void 0&&typeof t.backLabel!="string"&&e.push(`steps[${n}].backLabel must be a string`),t.nextLabel!==void 0&&typeof t.nextLabel!="string"&&e.push(`steps[${n}].nextLabel must be a string`),t.pageUrl!==void 0&&le(t.pageUrl,`steps[${n}].pageUrl`,e),t.condition!==void 0&&ce(t.condition,`steps[${n}].condition`,e),t.action!==void 0&&ze(t.action,`steps[${n}].action`,e)}):e.push("tour.steps must be an array"),r.trigger!==void 0){const t=r.trigger,n=["manual","load","selector","timer","cta"],i=["bottom-right","bottom-left","top-right","top-left"];!C(t)||typeof t.type!="string"||!n.includes(t.type)?e.push(`tour.trigger.type must be one of ${n.join("|")}`):t.type==="selector"&&(typeof t.selector!="string"||t.selector.length===0)?e.push("tour.trigger.selector must be a non-empty string"):t.type==="timer"&&(typeof t.delay!="number"||t.delay<0)?e.push("tour.trigger.delay must be a non-negative number"):t.type==="cta"&&(typeof t.text!="string"&&e.push("tour.trigger.text must be a string"),typeof t.button!="string"&&e.push("tour.trigger.button must be a string"),i.includes(t.corner)||e.push(`tour.trigger.corner must be one of ${i.join("|")}`),t.offset!==void 0&&(typeof t.offset!="number"||t.offset<0)&&e.push("tour.trigger.offset must be a non-negative number"))}if(r.audience!==void 0&&!["all","auth","guest"].includes(r.audience)&&e.push("tour.audience must be one of all|auth|guest"),r.display!==void 0)if(!C(r.display))e.push("tour.display must be an object");else for(const t of["padding","radius","cardRadius","offset","alignOffset"]){const n=r.display[t];n!==void 0&&(typeof n!="number"||n<0)&&e.push(`tour.display.${t} must be a non-negative number`)}return r.rules!==void 0&&(Array.isArray(r.rules)?r.rules.forEach((t,n)=>{if(!C(t)){e.push(`rules[${n}] must be an object`);return}t.tourId!==void 0&&typeof t.tourId!="string"&&e.push(`rules[${n}].tourId must be a string`),t.when===void 0?e.push(`rules[${n}].when is required`):ce(t.when,`rules[${n}].when`,e)}):e.push("tour.rules must be an array")),e.length>0?{ok:!1,errors:e}:{ok:!0,tour:r}}function Be(r,e,t){const n={top:r.top,bottom:t.height-r.bottom,left:r.left,right:t.width-r.right},i={top:e.height,bottom:e.height,left:e.width,right:e.width},o=["bottom","top","right","left"],s=o.find(l=>n[l]>=i[l]+8);return s||o.reduce((l,c)=>n[c]>n[l]?c:l,o[0])}function pe(r){const{target:e,card:t,offset:n,viewport:i}=r,o=r.side==="auto",s=o?Be(e,t,i):r.side,l=o?"center":r.align,c=r.alignOffset??0,d=l==="start"?c:l==="end"?-c:0;let u=0,f=0;return s==="top"||s==="bottom"?(u=s==="top"?e.top-t.height-n:e.bottom+n,f=l==="start"?e.left:l==="end"?e.right-t.width:e.left+e.width/2-t.width/2,f+=d):(f=s==="left"?e.left-t.width-n:e.right+n,u=l==="start"?e.top:l==="end"?e.bottom-t.height:e.top+e.height/2-t.height/2,u+=d),f=Math.max(8,Math.min(f,i.width-t.width-8)),u=Math.max(8,Math.min(u,i.height-t.height-8)),{top:u,left:f}}function ue(r){const e=document.createElement("button");return e.type="button",e.className=`tours-card__btn${r.primary?" tours-card__btn--primary":""}${r.disabled?" tours-card__btn--disabled":""}`,e.textContent=r.label,!r.disabled&&r.onClick&&e.addEventListener("click",r.onClick),e}function he(r){const e=document.createElement("div");if(e.className=`tours-card${r.ghost?" tours-card--ghost":""}`,r.radius!=null&&(e.style.borderRadius=`${r.radius}px`),r.showClose){const n=document.createElement("button");n.className="tours-card__close",n.type="button",n.textContent="×",n.setAttribute("aria-label","Close"),r.onClose&&n.addEventListener("click",r.onClose),e.appendChild(n)}const t=document.createElement("div");if(t.className="tours-card__content",r.contentHtml!=null?t.innerHTML=r.contentHtml:t.textContent=r.contentText??"",e.appendChild(t),r.back||r.next||r.progress){const n=document.createElement("div");if(n.className="tours-card__footer",r.back&&n.appendChild(ue(r.back)),r.progress){const i=document.createElement("span");i.className="tours-card__progress",i.textContent=r.progress,n.appendChild(i)}r.next&&n.appendChild(ue(r.next)),e.appendChild(n)}return e}const fe=`
.tours-card {
  position: fixed;
  z-index: 2147483001;
  box-sizing: border-box;
...
`;function Fe(r){const e=r.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"\0").replace(/\*/g,"[^/]*").replace(/ /g,".*").replace(/\?/g,".");return new RegExp(`^${e}$`)}function U(r,e){if(!r)return!0;if(r.regex)try{return new RegExp(r.regex).test(e)}catch{return!1}if(r.glob)try{return Fe(r.glob).test(e)}catch{return!1}return!0}function ge(r){if(!r||!r.glob)return null;const e=r.glob.replace(/\*+/g,"");return/^https?:\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:null}const X="tours:locationchange";let be=!1;function Ue(){if(!be){be=!0;for(const r of["pushState","replaceState"]){const e=history[r];history[r]=function(...n){const i=e.apply(this,n);return window.dispatchEvent(new Event(X)),i}}}}function je(r){return Ue(),window.addEventListener("popstate",r),window.addEventListener("hashchange",r),window.addEventListener(X,r),()=>{window.removeEventListener("popstate",r),window.removeEventListener("hashchange",r),window.removeEventListener(X,r)}}const me="tours:progress";function Ve(r,e){r.set(me,JSON.stringify(e))}function He(r){r.remove(me)}function We(r,e={}){const t=q("player"),n=e.state;let i=null,o=null,s=null,l=null,c=!1,d=0,u=0,f=null;const b=r.display?.padding??z,R=r.display?.radius??D,S=r.display?.cardRadius??B,h=r.display?.offset??F;function m(p){return M(p.selectors)}function x(p){return U(p.pageUrl,window.location.href)}function I(){n&&Ve(n,{tourId:r.id,index:d})}function ke(){if(i)return;i=document.createElement("div"),i.setAttribute("data-tours-player",""),o=i.attachShadow({mode:"open"});const p=document.createElement("style");p.textContent=$e+fe,o.appendChild(p);const g=document.createElement("div");g.className="tours-backdrop",g.addEventListener("click",v=>{const w=r.steps[d],E=w?m(w):null;if(E){const L=E.getBoundingClientRect();if(v.clientX>=L.left-b&&v.clientX<=L.right+b&&v.clientY>=L.top-b&&v.clientY<=L.bottom+b)return}$()}),o.appendChild(g),s=document.createElement("div"),s.className="tours-spotlight",s.style.borderRadius=`${R}px`,o.appendChild(s),document.body.appendChild(i)}function _e(p,g=!1){s&&(s.style.transitionDuration=g?"0ms":"",s.style.display="block",s.style.left=`${p.left-b}px`,s.style.top=`${p.top-b}px`,s.style.width=`${p.width+b*2}px`,s.style.height=`${p.height+b*2}px`)}function Se(p,g){if(!l)return;const v={top:p.top-b,left:p.left-b,right:p.right+b,bottom:p.bottom+b,width:p.width+b*2,height:p.height+b*2},{top:w,left:E}=pe({target:v,card:{width:l.offsetWidth,height:l.offsetHeight},side:g.placement??"bottom",align:g.align??"center",offset:h,alignOffset:r.display?.alignOffset??0,viewport:{width:window.innerWidth,height:window.innerHeight}});l.style.left=`${E}px`,l.style.top=`${w}px`}function et(p){const g=Math.max(1,r.steps.length-u),v=Math.max(1,Math.min(d+1-u,g));l&&l.remove(),l=he({contentText:p.content.default,progress:`Step ${v} of ${g}`,showClose:!0,onClose:$,radius:S,back:{label:p.backLabel??"Back",disabled:d===0,onClick:te},next:{label:p.nextLabel??(d===g-1?"Done":"Next"),primary:!0,onClick:ee}}),o?.appendChild(l)}function P(){if(!c)return;const p=r.steps[d];if(!p){$();return}t.log("render step",d,p.id);const g=m(p);if(!g){t.log(`step "${p.id}" target not found yet — waiting`,p.selectors),Re(p.selectors,{timeout:4e3}).then(w=>{!c||r.steps[d]!==p||(w?P():(t.warn(`step "${p.id}" skipped: no element for selectors`,p.selectors),u+=1,d<r.steps.length-1?(d+=1,P()):$()))});return}ke(),g.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),et(p);const v=g.getBoundingClientRect();_e(v),Se(v,p)}function Ee(p){c&&(p.key==="Escape"?(p.preventDefault(),$()):p.key==="ArrowRight"?ee():p.key==="ArrowLeft"&&te())}function H(){if(!c)return;const p=r.steps[d];if(!p)return;const g=m(p);if(!g)return;const v=g.getBoundingClientRect();_e(v,!0),Se(v,p)}function tt(p=0){c||r.steps.length!==0&&(c=!0,d=Math.max(0,Math.min(p,r.steps.length-1)),u=0,t.log("start",r.id,`at ${d}/${r.steps.length}`),ke(),window.addEventListener("keydown",Ee,!0),window.addEventListener("resize",H,!0),window.addEventListener("scroll",H,!0),I(),P())}function nt(){s&&(s.style.display="none"),l&&(l.remove(),l=null)}function W(){nt(),!f&&(f=je(()=>{if(!c){f?.(),f=null;return}const p=r.steps[d];p&&x(p)&&(f?.(),f=null,P())}))}function Ce(){f&&(f(),f=null),c&&(c=!1,window.removeEventListener("keydown",Ee,!0),window.removeEventListener("resize",H,!0),window.removeEventListener("scroll",H,!0),i&&i.parentNode&&i.parentNode.removeChild(i),i=null,o=null,s=null,l=null)}function $(){t.log("stop"),Ce(),n&&He(n)}function ee(){if(!c)return;const p=d+1,g=r.steps[p];if(!g){$();return}if(x(g)){d=p,I(),P();return}d=p,I();const v=L=>{Ce(),e.onNavigate?e.onNavigate(L,g.id):window.location.assign(L)},w=r.steps[d-1]?.action;if(w&&w.type==="navigate"&&w.url){w.url.startsWith("#")?(t.log("page transition (hash navigate) → resume at",d),W(),window.location.hash=w.url):(t.log("page transition (navigate) → resume at",d),v(w.url));return}const E=ge(g.pageUrl);if(E){E.startsWith("#")?(t.log("page transition (derived hash) → resume at",d),W(),window.location.hash=E):(t.log("page transition (derived navigate) → resume at",d,E),v(E));return}t.log("page transition (wait) → resume at",d),W()}function te(){if(!c)return;const p=r.steps[d-1];if(p){if(x(p)){d-=1,I(),P();return}d-=1,I(),t.log("page transition back → resume at",d),W(),window.history.back()}}return{start:tt,stop:$,next:ee,prev:te}}const Je=`
:host {
  all: initial;
  --e-bg: #ffffff;
  --e-fg: #1f2733;
