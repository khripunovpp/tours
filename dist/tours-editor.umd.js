...
`;function I(r){return JSON.stringify(r)}function ge(r){return/^[a-zA-Z][\w-]*$/.test(r)&&r.length<=30&&!/\d{2,}/.test(r)&&!/^(css-|sc-|jsx-|emotion-|_|is-|has-)/.test(r)}function X(r){const e=[];let t=r;for(;t&&t!==document.body&&t.nodeType===1;){const n=t.tagName.toLowerCase(),i=t.parentElement;if(!i){e.unshift(n);break}const o=Array.from(i.children).filter(s=>s.tagName===t.tagName);e.unshift(o.length>1?`${n}:nth-of-type(${o.indexOf(t)+1})`:n),t=i}return`body > ${e.join(" > ")}`}function be(r){let e=r.parentElement;for(;e&&e!==document.body&&!e.id;)e=e.parentElement;if(!e||!e.id)return null;const t=[];let n=r;for(;n&&n!==e;){const i=n.tagName.toLowerCase(),o=n.parentElement;if(!o)return null;const s=Array.from(o.children).filter(l=>l.tagName===n.tagName);t.unshift(s.length>1?`${i}:nth-of-type(${s.indexOf(n)+1})`:i),n=o}return`#${CSS.escape(e.id)} > ${t.join(" > ")}`}const me=["data-testid","data-test","data-test-id","data-cy","data-qa","data-id","data-name"];function ve(r){const e=[],t=new Set,n=r.tagName.toLowerCase(),i=d=>{if(!(!d||t.has(d)))try{document.querySelector(d)===r&&(t.add(d),e.push(d))}catch{}};r.id&&i(`#${CSS.escape(r.id)}`);for(const d of me){const u=r.getAttribute(d);u&&i(`${n}[${d}=${I(u)}]`)}const o=r.getAttribute("name");o&&i(`${n}[name=${I(o)}]`);const s=r.getAttribute("aria-label");s&&i(`[aria-label=${I(s)}]`);const l=Array.from(r.classList).filter(ge);l.length&&i(`${n}.${l.map(d=>CSS.escape(d)).join(".")}`);for(const d of l)i(`${n}.${CSS.escape(d)}`);i(be(r)),i(X(r));const p=(r.textContent??"").replace(/\s+/g," ").trim();if(p&&p.length<=50&&/^(a|button|summary|label|h[1-6])$/.test(n)){const d=`text=${p}`;t.has(d)||(t.add(d),e.push(d))}return e.length===0&&e.push(X(r)),e}const xe="a, button, summary, label, h1, h2, h3, h4, h5, h6";function ye(r,e){if(r.startsWith("text=")){const t=r.slice(5).trim();for(const n of Array.from(e.querySelectorAll(xe)))if((n.textContent??"").replace(/\s+/g," ").trim()===t)return n;return null}try{return e.querySelector(r)}catch{return null}}function A(r,e=document){for(const t of r){const n=ye(t,e);if(n)return n}return null}function we(r,e={}){const t=e.root??document,n=A(r,t);return n?Promise.resolve(n):new Promise(i=>{let o=!1;const s=d=>{o||(o=!0,l.disconnect(),clearTimeout(p),i(d))},l=new MutationObserver(()=>{const d=A(r,t);d&&s(d)});l.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0});const p=setTimeout(()=>s(null),e.timeout??4e3)})}let C=null;function R(){if(C!==null)return C;try{C=new URLSearchParams(window.location.search).has("use_logs")}catch{C=!1}return C}function D(r){const e=`[tours:${r}]`;return{log:(...t)=>{R()&&console.log(e,...t)},warn:(...t)=>{R()&&console.warn(e,...t)},error:(...t)=>{R()&&console.error(e,...t)}}}function ke(r,e={}){const t=D("picker");let n=null,i=null,o=null,s=!1;function l(h){if(h===n)return!0;for(const f of e.ignore??[])if(f&&f.contains(h))return!0;return!1}function p(){if(n)return;n=document.createElement("div"),n.setAttribute("data-tours-picker",""),i=n.attachShadow({mode:"open"});const h=document.createElement("style");h.textContent=E,i.appendChild(h),o=document.createElement("div"),o.className="tours-picker-overlay",o.style.display="none",i.appendChild(o);const f=document.createElement("div");f.className="tours-picker-hint",f.textContent="Hover and click an element • Esc to cancel",i.appendChild(f),document.body.appendChild(n)}function d(h,f){const m=document.elementFromPoint(h,f);return!m||l(m)?null:m}function u(h){if(!s||!o)return;const f=d(h.clientX,h.clientY);if(!f){o.style.display="none";return}const m=f.getBoundingClientRect();o.style.display="block",o.style.left=`${m.left}px`,o.style.top=`${m.top}px`,o.style.width=`${m.width}px`,o.style.height=`${m.height}px`}function b(h){if(!s)return;const f=d(h.clientX,h.clientY);if(h.preventDefault(),h.stopPropagation(),!f)return;const m=ve(f);t.log("picked",m),y(),r(m)}function _(h){h.key==="Escape"&&(h.preventDefault(),y())}function L(){s||(s=!0,t.log("start"),p(),document.addEventListener("mousemove",u,!0),document.addEventListener("click",b,!0),document.addEventListener("keydown",_,!0))}function y(){s&&(s=!1,document.removeEventListener("mousemove",u,!0),document.removeEventListener("click",b,!0),document.removeEventListener("keydown",_,!0),n&&n.parentNode&&n.parentNode.removeChild(n),n=null,i=null,o=null)}return{start:L,stop:y}}const M=6,B=6,U=10,j=12,_e=1;function k(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function G(r){return k(r)&&typeof r.default=="string"}const K=["top","bottom","left","right","auto"],Z=["start","center","end"],Q=["mobile","tablet","desktop"],ee=["click","input","navigate","none"];function te(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}const n=typeof r.glob=="string"&&r.glob.length>0,i=typeof r.regex=="string"&&r.regex.length>0;if(!n&&!i&&t.push(`${e} must have a non-empty "glob" or "regex"`),i)try{new RegExp(r.regex)}catch{t.push(`${e}.regex is not a valid regular expression`)}}function ne(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}r.url!==void 0&&te(r.url,`${e}.url`,t),r.role!==void 0&&typeof r.role!="string"&&t.push(`${e}.role must be a string`),r.firstVisitOnly!==void 0&&typeof r.firstVisitOnly!="boolean"&&t.push(`${e}.firstVisitOnly must be a boolean`),r.device!==void 0&&!Q.includes(r.device)&&t.push(`${e}.device must be one of ${Q.join("|")}`),r.unlessSeen!==void 0&&typeof r.unlessSeen!="boolean"&&t.push(`${e}.unlessSeen must be a boolean`),r.maxShows!==void 0&&(typeof r.maxShows!="number"||r.maxShows<0)&&t.push(`${e}.maxShows must be a non-negative number`)}function Se(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}ee.includes(r.type)||t.push(`${e}.type must be one of ${ee.join("|")}`),r.url!==void 0&&typeof r.url!="string"&&t.push(`${e}.url must be a string`),r.value!==void 0&&typeof r.value!="string"&&t.push(`${e}.value must be a string`)}function Ee(r){const e=[];if(!k(r))return{ok:!1,errors:["tour must be an object"]};if((typeof r.id!="string"||r.id.length===0)&&e.push("tour.id must be a non-empty string"),typeof r.schemaVersion!="number"&&e.push("tour.schemaVersion must be a number"),G(r.title)||e.push('tour.title must be a localized text with a string "default"'),Array.isArray(r.steps)?r.steps.length===0?e.push("tour.steps must contain at least one step"):r.steps.forEach((t,n)=>{if(!k(t)){e.push(`steps[${n}] must be an object`);return}(typeof t.id!="string"||t.id.length===0)&&e.push(`steps[${n}].id must be a non-empty string`),(!Array.isArray(t.selectors)||t.selectors.length===0||!t.selectors.every(i=>typeof i=="string"&&i.length>0))&&e.push(`steps[${n}].selectors must be a non-empty array of non-empty strings`),G(t.content)||e.push(`steps[${n}].content must be a localized text with a string "default"`),t.placement!==void 0&&!K.includes(t.placement)&&e.push(`steps[${n}].placement must be one of ${K.join("|")}`),t.align!==void 0&&!Z.includes(t.align)&&e.push(`steps[${n}].align must be one of ${Z.join("|")}`),t.backLabel!==void 0&&typeof t.backLabel!="string"&&e.push(`steps[${n}].backLabel must be a string`),t.nextLabel!==void 0&&typeof t.nextLabel!="string"&&e.push(`steps[${n}].nextLabel must be a string`),t.pageUrl!==void 0&&te(t.pageUrl,`steps[${n}].pageUrl`,e),t.condition!==void 0&&ne(t.condition,`steps[${n}].condition`,e),t.action!==void 0&&Se(t.action,`steps[${n}].action`,e)}):e.push("tour.steps must be an array"),r.display!==void 0)if(!k(r.display))e.push("tour.display must be an object");else for(const t of["padding","radius","cardRadius","offset","alignOffset"]){const n=r.display[t];n!==void 0&&(typeof n!="number"||n<0)&&e.push(`tour.display.${t} must be a non-negative number`)}return r.rules!==void 0&&(Array.isArray(r.rules)?r.rules.forEach((t,n)=>{if(!k(t)){e.push(`rules[${n}] must be an object`);return}t.tourId!==void 0&&typeof t.tourId!="string"&&e.push(`rules[${n}].tourId must be a string`),t.when===void 0?e.push(`rules[${n}].when is required`):ne(t.when,`rules[${n}].when`,e)}):e.push("tour.rules must be an array")),e.length>0?{ok:!1,errors:e}:{ok:!0,tour:r}}function Ce(r,e,t){const n={top:r.top,bottom:t.height-r.bottom,left:r.left,right:t.width-r.right},i={top:e.height,bottom:e.height,left:e.width,right:e.width},o=["bottom","top","right","left"],s=o.find(l=>n[l]>=i[l]+8);return s||o.reduce((l,p)=>n[p]>n[l]?p:l,o[0])}function re(r){const{target:e,card:t,offset:n,viewport:i}=r,o=r.side==="auto",s=o?Ce(e,t,i):r.side,l=o?"center":r.align,p=r.alignOffset??0,d=l==="start"?p:l==="end"?-p:0;let u=0,b=0;return s==="top"||s==="bottom"?(u=s==="top"?e.top-t.height-n:e.bottom+n,b=l==="start"?e.left:l==="end"?e.right-t.width:e.left+e.width/2-t.width/2,b+=d):(b=s==="left"?e.left-t.width-n:e.right+n,u=l==="start"?e.top:l==="end"?e.bottom-t.height:e.top+e.height/2-t.height/2,u+=d),b=Math.max(8,Math.min(b,i.width-t.width-8)),u=Math.max(8,Math.min(u,i.height-t.height-8)),{top:u,left:b}}function ie(r){const e=document.createElement("button");return e.type="button",e.className=`tours-card__btn${r.primary?" tours-card__btn--primary":""}${r.disabled?" tours-card__btn--disabled":""}`,e.textContent=r.label,!r.disabled&&r.onClick&&e.addEventListener("click",r.onClick),e}function oe(r){const e=document.createElement("div");if(e.className=`tours-card${r.ghost?" tours-card--ghost":""}`,r.radius!=null&&(e.style.borderRadius=`${r.radius}px`),r.showClose){const n=document.createElement("button");n.className="tours-card__close",n.type="button",n.textContent="×",n.setAttribute("aria-label","Close"),r.onClose&&n.addEventListener("click",r.onClose),e.appendChild(n)}const t=document.createElement("div");if(t.className="tours-card__content",r.contentHtml!=null?t.innerHTML=r.contentHtml:t.textContent=r.contentText??"",e.appendChild(t),r.back||r.next||r.progress){const n=document.createElement("div");if(n.className="tours-card__footer",r.back&&n.appendChild(ie(r.back)),r.progress){const i=document.createElement("span");i.className="tours-card__progress",i.textContent=r.progress,n.appendChild(i)}r.next&&n.appendChild(ie(r.next)),e.appendChild(n)}return e}const se=`
.tours-card {
  position: fixed;
  z-index: 2147483001;
  box-sizing: border-box;
...
`;function $e(r){const e=r.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"\0").replace(/\*/g,"[^/]*").replace(/ /g,".*").replace(/\?/g,".");return new RegExp(`^${e}$`)}function Le(r,e){if(!r)return!0;if(r.regex)try{return new RegExp(r.regex).test(e)}catch{return!1}if(r.glob)try{return $e(r.glob).test(e)}catch{return!1}return!0}const ae="tours:progress";function Te(r,e){r.set(ae,JSON.stringify(e))}function Ae(r){r.remove(ae)}function Pe(r,e={}){const t=D("player"),n=e.state;let i=null,o=null,s=null,l=null,p=!1,d=0;const u=r.display?.padding??M,b=r.display?.radius??B,_=r.display?.cardRadius??U,L=r.display?.offset??j;function y(c){return A(c.selectors)}function h(c){return Le(c.pageUrl,window.location.href)}function f(){n&&Te(n,{tourId:r.id,index:d})}function m(){if(i)return;i=document.createElement("div"),i.setAttribute("data-tours-player",""),o=i.attachShadow({mode:"open"});const c=document.createElement("style");c.textContent=fe+se,o.appendChild(c);const g=document.createElement("div");g.className="tours-backdrop",o.appendChild(g),s=document.createElement("div"),s.className="tours-spotlight",s.style.borderRadius=`${b}px`,o.appendChild(s),document.body.appendChild(i)}function ce(c){s&&(s.style.display="block",s.style.left=`${c.left-u}px`,s.style.top=`${c.top-u}px`,s.style.width=`${c.width+u*2}px`,s.style.height=`${c.height+u*2}px`)}function pe(c,g){if(!l)return;const x={top:c.top-u,left:c.left-u,right:c.right+u,bottom:c.bottom+u,width:c.width+u*2,height:c.height+u*2},{top:q,left:De}=re({target:x,card:{width:l.offsetWidth,height:l.offsetHeight},side:g.placement??"bottom",align:g.align??"center",offset:L,alignOffset:r.display?.alignOffset??0,viewport:{width:window.innerWidth,height:window.innerHeight}});l.style.left=`${De}px`,l.style.top=`${q}px`}function Ie(c){const g=r.steps.length;l&&l.remove(),l=oe({contentText:c.content.default,progress:`Step ${d+1} of ${g}`,showClose:!0,onClose:S,radius:_,back:{label:c.backLabel??"Back",disabled:d===0,onClick:Y},next:{label:c.nextLabel??(d===g-1?"Done":"Next"),primary:!0,onClick:J}}),o?.appendChild(l)}function T(){if(!p)return;const c=r.steps[d];if(!c){S();return}t.log("render step",d,c.id);const g=y(c);if(!g){t.log(`step "${c.id}" target not found yet — waiting`,c.selectors),we(c.selectors,{timeout:4e3}).then(q=>{!p||r.steps[d]!==c||(q?T():(t.warn(`step "${c.id}" skipped: no element for selectors`,c.selectors),d<r.steps.length-1?(d+=1,T()):S()))});return}m(),g.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),Ie(c);const x=g.getBoundingClientRect();ce(x),pe(x,c)}function ue(c){p&&(c.key==="Escape"?(c.preventDefault(),S()):c.key==="ArrowRight"?J():c.key==="ArrowLeft"&&Y())}function z(){if(!p)return;const c=r.steps[d];if(!c)return;const g=y(c);if(!g)return;const x=g.getBoundingClientRect();ce(x),pe(x,c)}function Re(c=0){p||r.steps.length!==0&&(p=!0,d=Math.max(0,Math.min(c,r.steps.length-1)),t.log("start",r.id,`at ${d}/${r.steps.length}`),m(),window.addEventListener("keydown",ue,!0),window.addEventListener("resize",z,!0),window.addEventListener("scroll",z,!0),f(),T())}function he(){p&&(p=!1,window.removeEventListener("keydown",ue,!0),window.removeEventListener("resize",z,!0),window.removeEventListener("scroll",z,!0),i&&i.parentNode&&i.parentNode.removeChild(i),i=null,o=null,s=null,l=null)}function S(){t.log("stop"),he(),n&&Ae(n)}function J(){if(!p)return;const c=d+1,g=r.steps[c];if(!g){S();return}if(h(g)){d=c,f(),T();return}d=c,f();const x=r.steps[d-1]?.action;t.log("page transition → resume at",d),he(),x&&x.type==="navigate"&&x.url&&window.location.assign(x.url)}function Y(){if(!p)return;const c=r.steps[d-1];!c||!h(c)||(d-=1,f(),T())}return{start:Re,stop:S,next:J,prev:Y}}const Ne=`
:host {
  all: initial;
  --e-bg: #ffffff;
  --e-fg: #1f2733;
