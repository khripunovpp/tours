(function(m,T){typeof exports=="object"&&typeof module<"u"?T(exports):typeof define=="function"&&define.amd?define(["exports"],T):(m=typeof globalThis<"u"?globalThis:m||self,T(m.Tours={}))})(this,(function(m){"use strict";const T=`
:host {
  all: initial;
}
...
`;let P=null;function M(){if(P!==null)return P;try{P=new URLSearchParams(window.location.search).has("use_logs")}catch{P=!1}return P}function O(r){const e=`[tours:${r}]`;return{log:(...t)=>{M()&&console.log(e,...t)},warn:(...t)=>{M()&&console.warn(e,...t)},error:(...t)=>{M()&&console.error(e,...t)}}}function de(r){if(r.id)return`#${CSS.escape(r.id)}`;const e=[];let t=r;for(;t&&t!==document.body&&t.nodeType===1;){const n=t.tagName.toLowerCase(),o=t.parentElement;if(!o){e.unshift(n);break}const i=Array.from(o.children).filter(a=>a.tagName===t.tagName);if(i.length>1){const a=i.indexOf(t)+1;e.unshift(`${n}:nth-of-type(${a})`)}else e.unshift(n);t=o}return`body > ${e.join(" > ")}`}function le(r,e={}){const t=O("picker");let n=null,o=null,i=null,a=!1;function d(c){if(c===n)return!0;for(const u of e.ignore??[])if(u&&u.contains(c))return!0;return!1}function f(){if(n)return;n=document.createElement("div"),n.setAttribute("data-tours-picker",""),o=n.attachShadow({mode:"open"});const c=document.createElement("style");c.textContent=T,o.appendChild(c),i=document.createElement("div"),i.className="tours-picker-overlay",i.style.display="none",o.appendChild(i);const u=document.createElement("div");u.className="tours-picker-hint",u.textContent="Hover and click an element • Esc to cancel",o.appendChild(u),document.body.appendChild(n)}function x(c,u){const g=document.elementFromPoint(c,u);return!g||d(g)?null:g}function S(c){if(!a||!i)return;const u=x(c.clientX,c.clientY);if(!u){i.style.display="none";return}const g=u.getBoundingClientRect();i.style.display="block",i.style.left=`${g.left}px`,i.style.top=`${g.top}px`,i.style.width=`${g.width}px`,i.style.height=`${g.height}px`}function I(c){if(!a)return;const u=x(c.clientX,c.clientY);if(c.preventDefault(),c.stopPropagation(),!u)return;const g=de(u);t.log("picked",g),E(),r([g])}function N(c){c.key==="Escape"&&(c.preventDefault(),E())}function D(){a||(a=!0,t.log("start"),f(),document.addEventListener("mousemove",S,!0),document.addEventListener("click",I,!0),document.addEventListener("keydown",N,!0))}function E(){a&&(a=!1,document.removeEventListener("mousemove",S,!0),document.removeEventListener("click",I,!0),document.removeEventListener("keydown",N,!0),n&&n.parentNode&&n.parentNode.removeChild(n),n=null,o=null,i=null)}return{start:D,stop:E}}const U=6,j=6,V=10,ce=1;function k(r){return typeof r=="object"&&r!==null&&!Array.isArray(r)}function q(r){return k(r)&&typeof r.default=="string"}const X=["top","bottom","left","right"],G=["mobile","tablet","desktop"],K=["click","input","navigate","none"];function Z(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}const n=typeof r.glob=="string"&&r.glob.length>0,o=typeof r.regex=="string"&&r.regex.length>0;if(!n&&!o&&t.push(`${e} must have a non-empty "glob" or "regex"`),o)try{new RegExp(r.regex)}catch{t.push(`${e}.regex is not a valid regular expression`)}}function Q(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}r.url!==void 0&&Z(r.url,`${e}.url`,t),r.role!==void 0&&typeof r.role!="string"&&t.push(`${e}.role must be a string`),r.firstVisitOnly!==void 0&&typeof r.firstVisitOnly!="boolean"&&t.push(`${e}.firstVisitOnly must be a boolean`),r.device!==void 0&&!G.includes(r.device)&&t.push(`${e}.device must be one of ${G.join("|")}`),r.unlessSeen!==void 0&&typeof r.unlessSeen!="boolean"&&t.push(`${e}.unlessSeen must be a boolean`),r.maxShows!==void 0&&(typeof r.maxShows!="number"||r.maxShows<0)&&t.push(`${e}.maxShows must be a non-negative number`)}function pe(r,e,t){if(!k(r)){t.push(`${e} must be an object`);return}K.includes(r.type)||t.push(`${e}.type must be one of ${K.join("|")}`),r.url!==void 0&&typeof r.url!="string"&&t.push(`${e}.url must be a string`),r.value!==void 0&&typeof r.value!="string"&&t.push(`${e}.value must be a string`)}function ue(r){const e=[];if(!k(r))return{ok:!1,errors:["tour must be an object"]};if((typeof r.id!="string"||r.id.length===0)&&e.push("tour.id must be a non-empty string"),typeof r.schemaVersion!="number"&&e.push("tour.schemaVersion must be a number"),q(r.title)||e.push('tour.title must be a localized text with a string "default"'),Array.isArray(r.steps)?r.steps.length===0?e.push("tour.steps must contain at least one step"):r.steps.forEach((t,n)=>{if(!k(t)){e.push(`steps[${n}] must be an object`);return}(typeof t.id!="string"||t.id.length===0)&&e.push(`steps[${n}].id must be a non-empty string`),(!Array.isArray(t.selectors)||t.selectors.length===0||!t.selectors.every(o=>typeof o=="string"&&o.length>0))&&e.push(`steps[${n}].selectors must be a non-empty array of non-empty strings`),q(t.content)||e.push(`steps[${n}].content must be a localized text with a string "default"`),t.placement!==void 0&&!X.includes(t.placement)&&e.push(`steps[${n}].placement must be one of ${X.join("|")}`),t.pageUrl!==void 0&&Z(t.pageUrl,`steps[${n}].pageUrl`,e),t.condition!==void 0&&Q(t.condition,`steps[${n}].condition`,e),t.action!==void 0&&pe(t.action,`steps[${n}].action`,e)}):e.push("tour.steps must be an array"),r.display!==void 0)if(!k(r.display))e.push("tour.display must be an object");else for(const t of["padding","radius","cardRadius"]){const n=r.display[t];n!==void 0&&(typeof n!="number"||n<0)&&e.push(`tour.display.${t} must be a non-negative number`)}return r.rules!==void 0&&(Array.isArray(r.rules)?r.rules.forEach((t,n)=>{if(!k(t)){e.push(`rules[${n}] must be an object`);return}t.tourId!==void 0&&typeof t.tourId!="string"&&e.push(`rules[${n}].tourId must be a string`),t.when===void 0?e.push(`rules[${n}].when is required`):Q(t.when,`rules[${n}].when`,e)}):e.push("tour.rules must be an array")),e.length>0?{ok:!1,errors:e}:{ok:!0,tour:r}}const A=12;function he(r){var oe,ie,se;const e=O("player");let t=null,n=null,o=null,i=null,a=!1,d=0;const f=((oe=r.display)==null?void 0:oe.padding)??U,x=((ie=r.display)==null?void 0:ie.radius)??j,S=((se=r.display)==null?void 0:se.cardRadius)??V;function I(l){for(const h of l.selectors)try{const p=document.querySelector(h);if(p)return p}catch{}return null}function N(){if(t)return;t=document.createElement("div"),t.setAttribute("data-tours-player",""),n=t.attachShadow({mode:"open"});const l=document.createElement("style");l.textContent=ae,n.appendChild(l);const h=document.createElement("div");h.className="tours-backdrop",n.appendChild(h),o=document.createElement("div"),o.className="tours-spotlight",o.style.borderRadius=`${x}px`,n.appendChild(o),i=document.createElement("div"),i.className="tours-tooltip",i.style.borderRadius=`${S}px`,n.appendChild(i),document.body.appendChild(t)}function D(l){o&&(o.style.display="block",o.style.left=`${l.left-f}px`,o.style.top=`${l.top-f}px`,o.style.width=`${l.width+f*2}px`,o.style.height=`${l.height+f*2}px`)}function E(l,h){if(!i)return;const p=i.offsetWidth,w=i.offsetHeight,$=window.innerWidth,L=window.innerHeight;let b,v;const _=h??"bottom";switch(_){case"top":b=l.top-w-A,v=l.left+l.width/2-p/2;break;case"left":b=l.top+l.height/2-w/2,v=l.left-p-A;break;case"right":b=l.top+l.height/2-w/2,v=l.right+A;break;case"bottom":default:b=l.bottom+A,v=l.left+l.width/2-p/2;break}_==="bottom"&&b+w>L&&(b=l.top-w-A),v=Math.max(8,Math.min(v,$-p-8)),b=Math.max(8,Math.min(b,L-w-8)),i.style.left=`${v}px`,i.style.top=`${b}px`}function c(l){if(!i)return;const h=r.steps.length;i.textContent="";const p=document.createElement("button");p.className="tours-close",p.type="button",p.textContent="×",p.setAttribute("aria-label","Close"),p.addEventListener("click",C),i.appendChild(p);const w=document.createElement("p");w.className="tours-tooltip__content",w.textContent=l.content.default,i.appendChild(w);const $=document.createElement("div");$.className="tours-tooltip__footer";const L=document.createElement("span");L.className="tours-tooltip__progress",L.textContent=`Step ${d+1} of ${h}`,$.appendChild(L);const b=document.createElement("div");b.className="tours-tooltip__buttons";const v=document.createElement("button");v.className="tours-btn",v.type="button",v.textContent="Back",v.disabled=d===0,v.addEventListener("click",Y),b.appendChild(v);const _=document.createElement("button");_.className="tours-btn tours-btn--primary",_.type="button",_.textContent=d===h-1?"Done":"Next",_.addEventListener("click",J),b.appendChild(_),$.appendChild(b),i.appendChild($)}function u(){if(!a)return;const l=r.steps[d];if(!l){C();return}e.log("render step",d,l.id);const h=I(l);if(!h){e.warn(`step "${l.id}" skipped: no element for selectors`,l.selectors),d<r.steps.length-1?(d+=1,u()):C();return}N(),h.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),c(l);const p=h.getBoundingClientRect();D(p),E(p,l.placement)}function g(l){a&&(l.key==="Escape"?(l.preventDefault(),C()):l.key==="ArrowRight"?J():l.key==="ArrowLeft"&&Y())}function B(){if(!a)return;const l=r.steps[d];if(!l)return;const h=I(l);if(!h)return;const p=h.getBoundingClientRect();D(p),E(p,l.placement)}function ve(){a||r.steps.length!==0&&(a=!0,d=0,e.log("start",r.id,`${r.steps.length} steps`),N(),window.addEventListener("keydown",g,!0),window.addEventListener("resize",B,!0),window.addEventListener("scroll",B,!0),u())}function C(){a&&(a=!1,e.log("stop"),window.removeEventListener("keydown",g,!0),window.removeEventListener("resize",B,!0),window.removeEventListener("scroll",B,!0),t&&t.parentNode&&t.parentNode.removeChild(t),t=null,n=null,o=null,i=null)}function J(){if(a){if(d>=r.steps.length-1){C();return}d+=1,u()}}function Y(){a&&(d<=0||(d-=1,u()))}return{start:ve,stop:C,next:J,prev:Y}}const fe=`
:host {
  all: initial;
  --e-bg: #ffffff;
  --e-fg: #1f2733;
